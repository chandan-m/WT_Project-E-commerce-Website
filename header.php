...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="HnF.css?ver=<?php echo rand(111,999)?>">
</head>
<body>
    <div id="head-container">
        
        <div id="logo"><a href="home.php"><img id="logoimg" src="Images\logo.jpg" alt="Shopping" ></a></div>
        <div id="search">
        ...
        <?php if (isset($_SESSION['username'])): ?>
            <p style='float:right;color:white;padding:30px;'>Welcome <strong><?php echo $_SESSION['username']; ?></strong></p>
        <?php endif ?>
    </div>
