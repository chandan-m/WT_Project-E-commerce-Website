        ...
        <!--style="width:1000px;margin:auto;border: 3px solid green;padding:50px;border-radius:50px;"--> 
            ...
            while($row = mysqli_fetch_array($result))  
            {
                ...
                echo " 
                    ...
                    <div class='prcont' style='margin:25px;padding: 25px;width:250px;height:350px;background-color:white;border-radius:25px;border: 3px solid black;text-align: center;display:inline-block;'> 
